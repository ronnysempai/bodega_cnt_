<?php
	...
	if(!isset($filtro))
		$rs = mysql_query("select bodega.*,recinto.id_recinto,recinto.nombre_recinto from bodega,recinto where bodega.id_recinto= recinto.id_recinto and bodega.eliminado <> '1' limit $offset,$rows");
